...
export type BoardContextType = {
  ...
  addCard: (columnId: string, title: string) => void; // Generated by Copilot
};
...
const initialContextData: BoardContextType = {
  ...
  moveCard: noop,
  addList: noop,
  addCard: noop, // Generated by Copilot
}
...
export const BoardContextProvider = ({ children }: BoardContextProviderProps) => {
  ...
  return (
    <BoardContext.Provider value={{ board, moveCard, addList, addCard }}>
      {children}
